...
def parse_args(parse_args_manual):
    if not parse_args_manual:
    ...
    # assert args.max_num_patches_per_image <= args.max_avail_patches_per_image
...
def create_data_splits(args):
    ...
    devices = sorted(args.dataset_dir.glob('*'))
