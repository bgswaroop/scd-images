...
from _old_strcture.configure import Configure, SigNet
from _old_strcture.signature_net.data_rgb import Data
from _old_strcture.signature_net.utils import MultinomialClassificationScores
from _old_strcture.signature_net.utils import log_running_time
from _old_strcture.utils.training_utils import Utils
from _old_strcture.signature_net.utils import VisualizationUtils
...
class SigNetFlow(object):
    ...
    def train(cls):
        ...
        for epoch in range(init_epoch, SigNet.max_epochs + 1):
            ...
            # Early stopping
            stop_early, stop_early_message = Utils.early_stopping(patience=5, metric=history['val_loss'], delta=0.02)
            if stop_early:
...
if __name__ == '__main__':
    from _old_strcture.signature_net.utils import summary
