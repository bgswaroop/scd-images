...
from _old_strcture.miscellaneous.scd_delivery.main.scd_modules.signature_net import SignatureNet1
from _old_strcture.miscellaneous.scd_delivery.main.scd_modules.similarity_net import SimilarityNet
